...
const BASE_PATH = "/reports/activity-by-district-school";
...
export default async function ActivityByDistrictSchoolPage({
  searchParams,
}: {
  ...
  return (
    <div className="flex flex-1 flex-col gap-5">
      <ReportToolbar title="Activity by District/School" xlsxHref={xlsxHref(filters, schoolYear?.legacyId)} />
      ...
      <div className="print:block hidden text-[13px] font-bold">
        Activity by District/School — {schoolYear?.label ?? ""}
                ...
                <details key={school.schoolId} className="rounded-[10px] border ml-2 print:break-inside-avoid" style={{ borderColor: "var(--border)" }}>
                  ...
                  <div className="border-t" style={{ borderColor: "var(--border)" }}>
                    <div
                      ...
                      style={{ gridTemplateColumns: "1fr 70px", color: "var(--muted)" }}
                    >
